...
def send(filename,receiver_IP,receiver_port,MSS,WINDOW_SIZE,TIME_OUT):
        ...
        while True:
            ...
            print(f"Sending packets {window_start} till {window_end}.")
            ...
            try:
                ...
                if ack <= window_end:
                    ...
                    print("Sliding the window 1 step to the right.")
                    window_start = ack + 1
                    print("*"*40)
            except OSError:
                print(f"Resending packets {window_start} till {window_end}.")
                print("*"*40)
